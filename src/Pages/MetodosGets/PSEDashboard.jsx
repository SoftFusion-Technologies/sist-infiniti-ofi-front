...
export default function PSEDashboard() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-br from-purple-50 via-white to-purple-100">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
            ...
            <div className="sm:ml-auto flex items-center gap-2">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full bg-purple-600 text-white px-4 py-2 text-sm font-semibold shadow hover:bg-purple-700"
              >
      ...
      <button
        onClick={() => openCreate(tab)}
        className="md:hidden fixed bottom-5 right-5 rounded-full h-14 w-14 flex items-center justify-center shadow-xl bg-purple-600 hover:bg-purple-700 text-white"
