    ...
    <>
      ...
      <div className="min-h-screen pt-10 pb-10 bg-[radial-gradient(ellipse_at_top,rgba(2,6,23,1),rgba(2,6,23,1))]">
        ...
        <section className="max-w-7xl mx-auto px-4 py-10">
          <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
            ...
            <div className="w-full sm:w-auto flex justify-center sm:justify-end">
              <button
                ...
                className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-xl font-medium flex items-center gap-2 transition"
              >
          ...
          {loading ? (
            <div className="flex justify-center py-16 text-purple-600 text-lg">
