...
const Navbar = () => {
  ...
  return (
    <nav className="relative z-50 bg-gray-900 text-gray-100 flex items-center h-24 max-w-full mx-auto px-6 border-b border-gray-700">
      ...
      <NavLink to="/" className="flex items-center gap-3">
        ...
        <div className="flex flex-col leading-none">
          <div className="flex items-center gap-1">
            <span className="text-3xl font-custom-montserrat text-transparent bg-clip-text bg-gradient-to-r from-gray-200 via-gray-400 to-gray-600">
              INFINITY
            </span>
          </div>
          <span className="text-xl font-custom-montserrat text-gray-300 text-center">
            Academia
          </span>
        </div>
      </NavLink>
      ...
      <ul className="hidden md:flex items-center gap-10 absolute left-1/2 -translate-x-1/2">
        {[
          ...
          <li key={item.name} className="relative group">
            ...
            <span className="pointer-events-none absolute -bottom-1 left-0 h-[2px] w-full bg-gray-300 rounded-full origin-left scale-x-0 transition-transform duration-200 group-hover:scale-x-100" />
          </li>
        ))}
      </ul>
      ...
      <div className="ml-auto hidden md:block">
        <NavLink to="/clase-prueba">
          <button
            className="
        px-5 py-2 font-bold text-gray-900 rounded-md
      ...
      <div
        className={
          nav
            ? 'fixed md:hidden left-0 top-0 w-full h-full bg-gray-900 ease-in-out duration-300 z-40'
